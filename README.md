...
## Трейсы
Для работы с распределёнными трейсами используется **_Grafana Tempo_**. Трейсы помогают отслеживать выполнение запросов и взаимодействие между различными компонентами API.
Трейсы включают следующую информацию:
...
![image](https://github.com/user-attachments/assets/be432f12-2ab8-477f-8998-84606efff515)
